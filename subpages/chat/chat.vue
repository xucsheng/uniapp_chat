<template>
	<view>
		...
		<view class="chat-body">
			<block v-for="(item,index) in chatList" :key="index">
			  <view class="chat-one" v-if="!item.isMe">
				     <image class="chat-face" src="@/static/faces/avatar38.png"/>
				     <view class="chat-box">
			   ...
			   <view  v-else  class="chat-one chat-one-mine">
			   	<view class="chat-box">
			     	...
			     	<image class="chat-face" src="@/static/faces/avatar20.png"/>
			   </view>
			</block>
		</view>
		<!--聊天输入-->
		<view class="chat-footer">
			...
			<image class="img-chose" src="@/static/img/img.png" @click="choseImgAndSend"/>
			...
			return {
				...
				chatList:[
					...
					},
					{
						isMe:false,
						type:'img',
						content:'/static/img/1681721956121.png'
					},
					{
						isMe:true,
						type:'txt',
					...
					},
					{
						isMe:true,
						type:'img',
						content:'/static/img/1681722009003.png'
					}
				],
			}
		},
